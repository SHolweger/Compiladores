...
_lr_productions = [
  ...
  ('programa -> INICIO PARENIZQ PARENDER LLAVEIZQ sentencias LLAVEDER','programa',6,'p_programa','tempCodeRunnerFile.py',34),
  ('sentencias -> sentencia','sentencias',1,'p_sentencias','tempCodeRunnerFile.py',38),
  ('sentencias -> sentencia sentencias','sentencias',2,'p_sentencias','tempCodeRunnerFile.py',39),
  ('sentencia -> NUMERO IDENTIFICADOR IGUAL expresion PUNTOYCOMA','sentencia',5,'p_sentencia_declaracion','tempCodeRunnerFile.py',43),
  ('sentencia -> DECIMAL IDENTIFICADOR IGUAL expresion PUNTOYCOMA','sentencia',5,'p_sentencia_declaracion','tempCodeRunnerFile.py',44),
  ('sentencia -> BOOLEANO IDENTIFICADOR IGUAL booleano PUNTOYCOMA','sentencia',5,'p_sentencia_declaracion','tempCodeRunnerFile.py',45),
  ('sentencia -> IDENTIFICADOR IGUAL expresion PUNTOYCOMA','sentencia',4,'p_sentencia_asignacion','tempCodeRunnerFile.py',49),
  ('sentencia -> SI PARENIZQ condicion PARENDER LLAVEIZQ sentencias LLAVEDER','sentencia',7,'p_sentencia_si','tempCodeRunnerFile.py',54),
  ('sentencia -> SI PARENIZQ condicion PARENDER LLAVEIZQ sentencias LLAVEDER SINO LLAVEIZQ sentencias LLAVEDER','sentencia',11,'p_sentencia_si','tempCodeRunnerFile.py',55),
  ('sentencia -> REGRESA IDENTIFICADOR PUNTOYCOMA','sentencia',3,'p_sentencia_regresa','tempCodeRunnerFile.py',59),
  ('expresion -> expresion SUMA expresion','expresion',3,'p_expresion','tempCodeRunnerFile.py',64),
  ('expresion -> expresion RESTA expresion','expresion',3,'p_expresion','tempCodeRunnerFile.py',65),
  ('expresion -> expresion MULT expresion','expresion',3,'p_expresion','tempCodeRunnerFile.py',66),
  ('expresion -> expresion DIV expresion','expresion',3,'p_expresion','tempCodeRunnerFile.py',67),
  ('expresion -> NUMERO','expresion',1,'p_expresion','tempCodeRunnerFile.py',68),
  ('expresion -> DECIMAL','expresion',1,'p_expresion','tempCodeRunnerFile.py',69),
  ('expresion -> IDENTIFICADOR','expresion',1,'p_expresion','tempCodeRunnerFile.py',70),
  ('booleano -> VERDADERO','booleano',1,'p_booleano','tempCodeRunnerFile.py',83),
  ('booleano -> FALSO','booleano',1,'p_booleano','tempCodeRunnerFile.py',84),
  ('condicion -> IDENTIFICADOR MAYOR IDENTIFICADOR','condicion',3,'p_condicion','tempCodeRunnerFile.py',88),
  ('condicion -> IDENTIFICADOR MENOR IDENTIFICADOR','condicion',3,'p_condicion','tempCodeRunnerFile.py',89),
  ('condicion -> IDENTIFICADOR IGUAL_IGUAL IDENTIFICADOR','condicion',3,'p_condicion','tempCodeRunnerFile.py',90),
]
